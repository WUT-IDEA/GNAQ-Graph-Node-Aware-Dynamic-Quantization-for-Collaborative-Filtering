...
def config_parser() -> ArgumentParser:
    ...
    parser.add_argument('--test_batch', type=int, default=20480,
    ...
    parser.add_argument('--dataset_name', type=str, default='gowalla',
                        choices=["gowalla", "yelp2020", "amazon-book", "movie"],
    ...
    parser.add_argument("--pretrain_state_dict", type=str, default="checkpoints/bgr-gowalla-256-rank.pth.tar",
                        help='')
    parser.add_argument("--use_pretrain_init", action="store_true",
                        help='')
    return parser
